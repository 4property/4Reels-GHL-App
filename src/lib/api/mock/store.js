/**
 * In-memory mock store. Mutable — mock handlers can write to it so that
 * POST/PUT/DELETE behave realistically across the session (not persisted).
 *
 * Each top-level key matches a backend resource. Keep shapes identical to what
 * the real API will return.
 */
